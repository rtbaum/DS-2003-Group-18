...
question1data <- injuries %>%
  select(RosterPosition, BodyPart, StadiumType, FieldType, Temperature, Weather, PlayType, Days_Missed)
View(question1data)
```
...
###Grouped Bar Graph
```{r}
injuries$BodyPart <- as.factor(injuries$BodyPart)
ggplot(injuries, aes(fill = Days_Missed, x = BodyPart, y = count) +
