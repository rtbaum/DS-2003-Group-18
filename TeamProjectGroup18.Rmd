...
injury.labels <- c(RosterPosition = "This is the position the athlete has on the football team",
         BodyPart = "This varaible records where the injury took place on the body",
         StadiumType = "The playing surface of the field when the injury occured",
         Temperature = "Temputre recorded when the injury took place in Farhenheit",
