...
# Once we make each chart using plot_ly we will be able to use buttons to change the colors of the bars using a color palette that is color blind friendly
